...
![01_简单了解多线程](/tupian/01_简单了解多线程.png)

### 1.2 并发和并行【理解】

- 并行：在同一时刻，有多个指令在多个 CPU 上同时执行。

  ![02_并行](/tupian/02_并行.png)

- 并发：在同一时刻，有多个指令在单个 CPU 上交替执行。

  ![03_并发](/tupian/03_并发.png)
...
- 线程调度
  ...
  - 随机性
    ...
    ![05_多线程示例图](/tupian/05_多线程示例图.png)
...
- 阻塞队列继承结构
  ...
  ![06_阻塞队列继承结构](/tupian/06_阻塞队列继承结构.png)
